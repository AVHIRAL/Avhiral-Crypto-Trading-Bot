...
class TradingBot:
    ...
    def load_key(self):
        ...
        if os.path.isfile("xor_key_binance.txt"):
            with open("xor_key_binance.txt", "r") as key_file:
                self.xor_cipher = XORCipher(key_file.read())
        else:
            # Create a new XOR cipher key and place it in xor_key_binance.txt
            key = "YOUR_GENERATED_KEY_HERE"  # Remplacez par votre propre clé
            with open("xor_key_binance.txt", "w") as key_file:
                key_file.write(key)
    ...
    def encrypt_and_save_credentials(self):
        ...
        # Save the encrypted information in xor_key_binance.txt
        with open("xor_key_binance.txt", "w") as key_file:
    ...
    def initialize_ui(self):
        ...
        root = tk.Tk()
        root.title("TRADING BINANCE BOT AVHIRAL V7.8")
    ...
    def get_crypto_pairs(self):
        try:
            ...
            crypto_pairs = [pair for pair in markets if pair.endswith('/USDT')]
            filtered_pairs = []
            ...
            # Gérer les erreurs DDoSProtection
            ...
            # Gérer les erreurs NetworkError
